...
<center>
  ...
  <tr>
    <td colspan="2" style="font-family:Times New Roman; font-size:24px; color:#990099;font-weight:bold; "><div align="center">Other Company Report </div></td>
  </tr>
  <tr>
    <td colspan="2">&nbsp;</td>
  </tr>
  ...
  <tr>
    ...
    <tr>
		<td style="background-color:#00FFFF;color:#000033">CID</td>
		<td style="background-color:#00FFFF;color:#000033">Name</td>
		<td style="background-color:#00FFFF;color:#000033">Address</td>
		<td style="background-color:#00FFFF;color:#000033">Proprietor</td>
		<td style="background-color:#00FFFF;color:#000033">Production</td>
		<td style="background-color:#00FFFF;color:#000033">MobileNo</td>
		<td style="background-color:#00FFFF;color:#000033">MailID</td>
		<td style="background-color:#00FFFF;color:#000033">ProfileInfo</td>
    </tr>
	<?php 
include("config.php");
...
//	$name=$_POST['name'];
	...
	while ($row = mysql_fetch_array($result))
          {
    ?>
    <tr style="font-family:Times New Roman; font-size:16px; " >
