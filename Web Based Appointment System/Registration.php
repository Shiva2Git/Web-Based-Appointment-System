...
<center>
  ...
  <tr>
    <td colspan="2" style="font-family:Times New Roman; font-size:24px; color:#990099;font-weight:bold; ">Other Company Registration </td>
  </tr>
  <tr>
    <td colspan="2">&nbsp;</td>
  </tr>
  ...
  <tr>
	...
	<?php
		include("config.php");
		$result =mysql_query("Select MAX(CID) as id from Register");
  ...
  <tr>
    ...
    <td>
        ...
        <input type="text" name="name" class="validate[required] text-input"/>    </td>
  </tr>
  <tr>
    <td>Address</td>
    <td><textarea rows="4" cols="30" name="addr" class="validate[required] text-input"></textarea></td>
  </tr>
  <tr>
    <td><strong>Proprietor</strong></td>
    <td><input type="text" name="prop" class="validate[required] text-input"/></td>
  </tr>
  <tr>
    <td>Production</td>
    <td><input type="text" name="prod"  class="validate[required] text-input"/></td>
  </tr>
  <tr>
    <td>Mobile No </td>
    <td><input type="text" name="mno"  class="validate[required,custom[phone]] text-input" /></td>
  </tr>
  <tr>
    <td>Mail ID </td>
    <td><input type="text" name="mail" class="validate[required,custom[email]] text-input"/></td>
  </tr>
  <tr>
    <td>Profile info </td>
    <td><textarea rows="4" cols="30" name="pinfo"  class="validate[required] text-input"></textarea></td>
  </tr>
  <tr>
    <td>Password </td>
    <td><input type="password" name="pwd"  class="validate[required] text-input" /></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
...
if(isset($_POST['Submit']))
{
	...
	$result=mysql_query("insert into Register value ('$id','$name','$addr','$fname','$occu','$mno','$mail','$dept','$pwd')");
	echo "<script text='text/javascript'>alert('Company Registered Successfully');</script>";
